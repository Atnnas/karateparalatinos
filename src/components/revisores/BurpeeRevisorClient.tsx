    ...
    return (
      <div className="relative z-10 flex-1 flex flex-col p-6 items-center justify-center max-w-5xl mx-auto w-full lg:flex-row lg:gap-16 min-h-[75vh]">
        ...
        <div className="text-center lg:text-left lg:flex-1 space-y-8 max-w-lg">
          ...
          <div className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-none p-6 flex flex-col items-center justify-center space-y-4">
    ...
    <div className="flex-1 flex flex-col relative w-full max-w-[1600px] mx-auto px-4 pt-6 z-10">
      ...
      <div className="flex items-center justify-between mb-6 w-full border-b border-white/5 pb-4">
        <button
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-none bg-white/5 text-zinc-400 hover:text-white hover:bg-white/10 transition-all border border-white/5 text-xs font-black uppercase tracking-wider"
          title="Volver"
        >
      ...
      <div className="flex flex-col xl:flex-row gap-6 w-full items-stretch justify-center">
        ...
        <div className="w-full aspect-[4/3] lg:max-h-[55vh] relative flex flex-col items-center justify-center bg-zinc-950 rounded-none border border-neutral-800 overflow-hidden p-2 md:p-3 shadow-2xl">
          ...
          <div className="relative w-full flex-1 bg-zinc-950 rounded-none overflow-hidden shadow-inner border border-white/10 flex items-center justify-center">
            ...
            {/* Active profile hud */}
            <div className="absolute top-4 right-12 bg-zinc-950/80 border border-white/10 px-3 py-1.5 rounded-none text-[10px] font-black uppercase tracking-wider text-zinc-400 flex items-center gap-1.5 backdrop-blur-sm shadow-md">
              <Activity className="w-3.5 h-3.5 text-cyan-400" />
              <span>Fase: <strong className="text-white uppercase">{getPhaseName(hasReachedBottom)}</strong></span>
            </div>

            {/* Live Angle HUD */}
            <div className="absolute bottom-4 left-4 bg-zinc-950/80 border border-white/10 p-3 rounded-none backdrop-blur-sm shadow-md space-y-1">
              <div>
        ...
        <div className="w-full xl:w-[340px] flex flex-col justify-between gap-6">
          ...
          <div className="bg-zinc-950 border border-neutral-800 rounded-none p-6 backdrop-blur-md shadow-2xl flex-1 flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-4">
              <div className="bg-zinc-950/60 border border-white/5 rounded-none p-4 flex items-start gap-3">
                <div className="w-8 h-8 rounded-none bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-cyan-400 shrink-0 mt-0.5">
              ...
              <div className="bg-zinc-950/60 border border-white/5 rounded-none p-4 flex items-start gap-3">
                <div className="w-8 h-8 rounded-none bg-kuma-gold/10 border border-kuma-gold/20 flex items-center justify-center text-kuma-gold shrink-0 mt-0.5">
