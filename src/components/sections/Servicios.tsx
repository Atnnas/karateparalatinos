  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full">
        ...
        {/* Content Section (Grid: Video + Copy) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
          
          {/* Column 1: Video Player (Left, taking 7 spans on large screens) */}
          <motion.div
          ...
          >
            <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl border border-neutral-200/80 bg-black">
              <iframe
          ...
          {/* Column 2: Content Checklist & Contact (Right, taking 5 spans) */}
          <div className="lg:col-span-5 space-y-6 lg:space-y-8">
            ...
            <motion.div
              ...
              className="glass-card p-6 sm:p-8 space-y-4 shadow-sm"
            >
              <h3 className="font-title-serif text-xs text-neutral-800 tracking-wider uppercase font-bold border-b border-neutral-200/60 pb-3">
                CONTENIDO INCLUIDO
              </h3>
              <ul className="space-y-4">
                {listItems.map((item, index) => (
                  <li key={index} className="flex items-start gap-3 text-neutral-800 text-sm sm:text-base font-normal leading-relaxed">
