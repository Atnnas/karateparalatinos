...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* ===== Content Section ===== */}
      <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center w-full">
          ...
          {/* Column 2: Sensei Image (Right) */}
          <div className="lg:col-span-5 relative h-[450px] sm:h-[550px] lg:h-[650px] w-full flex items-end justify-center z-10 mt-8 lg:mt-0">
            {/* ===== Stylized Rising Sun (Hinomaru) behind the sensei ===== */}
            ...
            >
              <Image
                ...
                fill
                className="object-contain object-bottom drop-shadow-[-25px_20px_40px_rgba(0,0,0,0.18)]"
                priority
                quality={100}
              />
            </motion.div>
