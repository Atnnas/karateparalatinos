      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full h-full flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-stretch w-full">
          ...
          <div className="lg:col-span-7 space-y-5 pb-8 lg:pb-12 pt-2 flex flex-col justify-center">
            ...
            >
              <span className="font-title-serif text-[10px] text-[#556358] tracking-[0.25em] uppercase block">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                <span className="inline-flex items-center gap-1.5 bg-[#E52B34]/8 border border-[#E52B34]/15 py-0.5 px-2.5 rounded text-[#E52B34] text-[10px] font-semibold uppercase tracking-wider">
                  <Target className="w-3 h-3" />
                  Dojo IKIGAI
                </span>
                <span className="inline-flex items-center gap-1.5 bg-[#8B6914]/8 border border-[#8B6914]/15 py-0.5 px-2.5 rounded text-[#8B6914] text-[10px] font-semibold uppercase tracking-wider">
            ...
            <motion.div
              ...
              className="grid grid-cols-3 gap-3 border-y border-neutral-200/60 py-4"
            >
              <div className="text-left">
                <span className="block font-impact-condensed text-2xl sm:text-3xl text-[#E52B34] leading-none">45+</span>
                <span className="block text-[9px] sm:text-[10px] text-neutral-500 uppercase tracking-widest font-semibold mt-1">Años de Estudio</span>
              </div>
              <div className="text-left border-x border-neutral-200/60 px-3">
                <span className="block font-impact-condensed text-2xl sm:text-3xl text-neutral-900 leading-none">5° Dan</span>
                <span className="block text-[9px] sm:text-[10px] text-neutral-500 uppercase tracking-widest font-semibold mt-1">Cinta Negra</span>
              </div>
              <div className="text-left">
                <span className="block font-impact-condensed text-2xl sm:text-3xl text-[#8B6914] leading-none">WSKF</span>
                <span className="block text-[9px] sm:text-[10px] text-neutral-500 uppercase tracking-widest font-semibold mt-1">Jun-Shihan</span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-3.5 text-neutral-700 text-xs sm:text-sm font-light leading-relaxed"
            >
              <p className="font-medium text-neutral-950 text-sm sm:text-base italic border-l-2 border-[#E52B34] pl-3 py-0.5">
            ...
            <motion.div
              ...
              className="bg-white/80 backdrop-blur-md border border-neutral-200/80 rounded-2xl p-5 shadow-sm space-y-3"
            >
              <h3 className="font-impact-condensed text-lg tracking-wider text-neutral-900 flex items-center gap-2 border-b border-neutral-100 pb-2">
                <span className="h-1.5 w-1.5 rounded-full bg-[#E52B34]" />
                EL SISTEMA DOJUTSU
              </h3>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1">
                  <span className="inline-block text-[10px] font-bold tracking-widest text-[#E52B34] uppercase bg-[#E52B34]/5 px-2 py-0.5 rounded">
                    DO (El Camino)
                  </span>
                ...
                <div className="space-y-1 border-t sm:border-t-0 sm:border-l border-neutral-200/60 pt-3 sm:pt-0 sm:pl-4">
                  <span className="inline-block text-[10px] font-bold tracking-widest text-[#8B6914] uppercase bg-[#8B6914]/5 px-2 py-0.5 rounded">
